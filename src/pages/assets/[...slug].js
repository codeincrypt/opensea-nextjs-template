			...
			<div className="container-max">
				<div className="row">
					<div className="col-lg-5 item-wrapper">
						<div className="item-summary">
							...
							<div className="border-card mb-4 mt-4">
								...
								<div className="card-body">
									<p> This is a test NFT collection that helps decentralized Finance, NFT Finance, Social
										Finance, and other kinds of Dapps building on Goerli Testnet.</p>

									<p>You can mint your own at mint function at https://www.testnetmint.com/ price is 0.01
										goerli ether per one, and max wallet mint is 2.</p>
								...
								<div className="card-body">
									<div className="flex">
										...
										<div className="col2 text-right">
											<p>{viewdata?.contract.slice(0, 6)}...{viewdata?.contract.substr(-4, 4)}</p>
										</div>
									</div>
									<div className="flex">
										<div className="col2">
					...
					<div className="col-lg-7 item-main">
						<p className="mb-3"><a className="a-text" href={`/collection/${viewdata?.collection}`}>{viewdata?.collection}</a></p>
						<h3 className="font-weight-bold">{viewdata?.name}</h3>
						<p>Owned by <span><a className="a-text" href={`/${viewdata?.creator}`}>{viewdata?.creator}</a></span> </p>
						...
						<div className="border-card mb-4">
							...
							<div className="card-body">
								...
								<h2 className="font-weight-bold">4.48 ETH <span className="h6 text-muted">$11,244.08</span> </h2>

								<div className="row mt-3">
									<div className="col-6">
										<button className="btn btns btn-block btn-primary">Buy Now</button>
									</div>
									<div className="col-6">
										<button className="btn btns btn-block btn-secondary">Make an offer</button>
									</div>
								</div>
							</div>
						</div>
						<div className="border-card">
							<div className="card-header"><i className="fa fa-server mr-2"></i> Price History</div>
							<div className="card-body p-5 text-center">
								<img src="https://testnets.opensea.io/static/images/empty-bids.svg" />
							</div>
						</div>
						<div className="border-card mt-4">
							<div className="card-header"><i className="fa fa-server mr-2"></i> Listings</div>
							<div className="card-body p-5 text-center">
								<img src="https://testnets.opensea.io/static/images/empty-bids.svg" />
							</div>
                       ...
                       table className="table">
                            ...
                            <tr>
                                <td className="h5 font-weight-bold">4.48 ETH</td>
                                <td>$11,244.08</td>
                                <td>1</td>
                                <td>in 2 days</td>
                                <td>WeZPeople</td>
                                <td> <button className="btn btn-sm btn-primary">Buy</button> </td>
                            </tr>
                            <tr>
                                <td className="h5 font-weight-bold">4.48 ETH</td>
                                <td>$11,244.08</td>
						...
						<div className="border-card mt-4">
							<div className="card-header"><i className="fa fa-server mr-2"></i> Offers</div>
							<div className="card-body p-5 text-center">
								<img src="https://testnets.opensea.io/static/images/empty-bids.svg" />
							</div>
						</div>
